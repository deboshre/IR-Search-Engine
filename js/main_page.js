...
var url = 'http://18.188.194.230:5000/getDefaultResults'
...
function AddTrends(tag, count) {
  ...
  window.onload = function(){
    if(Boolean(window.location.search)){
      ...
      if(Boolean(data)){
        data = data.split("=");
        document.getElementById("search_panel").value = data[1];
  ...
  fetch("http://18.188.194.230:5000/trending").then(x => x.json()).then(y => {
